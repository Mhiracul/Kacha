  ...
  return (
    <div className="w-full h-full overflow-hidden">
      <section className="relative h-full font-outfit w-full flex flex-col items-center">
        ...
        {/* Slide Content */}
        <div className="relative z-10 flex flex-col justify-center items-start h-full py-44 text-left text-white container mx-auto px-16">
          <div className="text-[#f5b754] text-[10px] tracking-[0.3em] uppercase">
            Kacha
          </div>
          <h1 className="md:text-5xl text-3xl py-6 font-bold mb-4">
            <span className="text-white">About </span>
            <span className="text-[#f5b754]">Us</span>
          </h1>
        </div>
      </section>
    </div>
